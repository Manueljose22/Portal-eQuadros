...
export default function OfertasFormativasSection() {
    return (
        <div className="card-bg">
            <div className="container-max mx-auto py-12 px-4 lg:px-[100px]">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-6 mb-12 items-center">
                    ...
                    <div className="h-full">
                        ...
                        <Link to="#" className="btn-primary w-full py-3  max-w-[170px] h-full max-h-[50px] flex items-center justify-center text-white  rounded-full hover:bg-[#1A8BCA]">
                            Ver todas
                        </Link>
                    </div>
